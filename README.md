...
Run the ablation suite for width / activation / loss:

```bash
python codes/VGG_BatchNorm/VGG_Loss_Landscape.py --mode ablations --epochs 6 --train-subset 3000 --val-subset 1000 --optimizers adam --optimizer-lr 0.0001
```
